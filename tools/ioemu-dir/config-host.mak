...
# Configured with: '/XenSource/MemoryMonitor/tools/../tools/ioemu-qemu-xen/configure' '--disable-gfx-check' '--disable-curses' '--disable-slirp' '--prefix=/usr'
prefix=/usr
bindir=${prefix}/bin
...
VERSION=0.10.2
SRC_PATH=/XenSource/MemoryMonitor/tools/ioemu-qemu-xen
VPATH=/XenSource/MemoryMonitor/tools/ioemu-qemu-xen
...
XEN_ROOT=/XenSource/MemoryMonitor/tools/..
QEMU_ROOT ?= .
